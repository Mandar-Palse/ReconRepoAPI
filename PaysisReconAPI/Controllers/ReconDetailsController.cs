...
namespace PaysisReconAPI.Controllers
{
    ...
    public class ReconDetailsController : ControllerBase
    {
        ...
        public async Task<IActionResult> RaiseReconRequest([FromBody]RaiseReconRequestDto request)
        {
            string result = mastersService.Raise_request_reconServices(request.ReconGroupId, request.BusinessDate.ToString(), request.RequestedBy);
